                                ...
                                <div class="row custom-row">
                                    <div class="col-sm-12 orderinfoBox">
                                        ...
                                        <div class="row custom-row">
                                            ...
                                            <div class="col-sm-8">{{ $delivery_address['CustomerName'] }}</div>
                                        </div>
                                        <div class="row custom-row">
                                            <div class="col-sm-4">
                        ...
                        <div class="table-responsive">
                            <table class="table header-border table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>@if(isset($ProductVariant->variant_images))<img src="{{ url($ProductVariant->variant_images[0]) }}" width="50px" height="50px">@endif</td>
                                    <td class="multirow">
                                ...
                                @endforeach
                                <tr>
                                    <td class="text-right" colspan="5"><h5>Sub Total</h5></td>
                                    <td></td>
                                    <td><h5><i class="fa fa-inr" aria-hidden="true"></i> {{ $Order->sub_totalcost }}</h5></td>
                                </tr>
                                <tr>
                                    <td class="text-right" colspan="5"><h5>Shipping Cost</h5></td>
                                    <td></td>
                                ...
                                <tr>
                                    <td class="text-right" colspan="5"><h5>Refund Amount</h5></td>
                                    <td></td>
                                    <td><h5><i class="fa fa-inr" aria-hidden="true"></i> {{ $Order->total_refund_amount }}</h5></td>
                                </tr>
                                <tr>
                                    <td class="text-right" colspan="5"><h5>Order Total Cost</h5></td>
                                    <td></td>
