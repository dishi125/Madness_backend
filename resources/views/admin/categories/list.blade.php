                    ...
                    <div class="card-body">
                        ...
                        <div class="action-section">
                            ...
                            @if(isset($action) && $action=='list')
                                <span class="col-md-3"><select class="form-control" id="category_id_filter">
...
function category_table(is_clearState=false){
    ...
    $('#Category').DataTable({
        ...
        "ajax":{
            ...
            "dataType": "json",
            "type": "POST",
            "data":{ _token: '{{ csrf_token() }}', category_id_filter: category_id_filter },
            // "dataSrc": ""
        },
        'columnDefs': [
        ...
        "columns": [
            ...
            {data: 'parent_category_name', name: 'parent_category_name', class: "text-left", orderable: false},
...
$('body').on('change', '#category_id_filter', function (e) {
    // e.preventDefault();
    category_table(true);
});
...
$('body').on("change","#parent_category_id",function(){
    ...
    if(category_id==''){
        ...
        $("#attribute_required_specification").hide();
        $("#attribute_optional_specification").hide();
        $("#order_return_days_textbox").hide();
        $("#attr-cover-spin").fadeOut();
    }
    else {
        $.get("{{ url('admin/categories/checkparentcat') }}" + '/' + category_id, function (data) {
            if (data) {
                $("#attribute_variation").show();
                $("#attribute_required_specification").show();
                $("#attribute_optional_specification").show();
                $("#order_return_days_textbox").show();
                $("#attr-cover-spin").fadeOut();
            } else {
                $("#attribute_variation").hide();
                $("#attribute_required_specification").hide();
