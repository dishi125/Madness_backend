...
{{--                        <br>--}}
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="media align-items-center mb-4">
                                ...
                                <img class="mr-3" src="{{ url('public/images/profile_pic/'.$user->profile_pic) }}" width="80" height="80" alt="Profile" id="Profile_pic_val">
                                @else
                                <img class="mr-3" src="{{ url('public/images/default_avatar.jpg') }}" width="80" height="80" alt="Profile" id="Profile_pic_val">
                                @endif
        ...
        success: function (res) {
            ...
            if(res.status == 200){
                ...
                if(res.user.profile_pic!=null) {
                    $('#Profile_pic_val').attr('src', "{{url('public/images/profile_pic')}}" +"/" + res.user.profile_pic);
                }
