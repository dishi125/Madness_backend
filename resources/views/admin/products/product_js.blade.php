<!-- product JS start -->
<script src="{{ url('public/js/bootstrap-4-navbar.js') }}"></script>
...
<script type="text/javascript">
    ...
    $(".last-child").click(function() {
        ...
        $("#childCategoryId").val(catSelectValArray[1]);
        catSelectStrArray = [];
        catSelectValArray = [];
        parentCatValArray = [];
        ...
        $.ajax({
            type: 'GET',
            url: "{{ url('admin/getAttrVariation') }}" +'/' + $("#childCategoryId").val(),
        ...
        $(".variantForm").each(function() {
            $(this).validate({
                ...
                messages : {
                    ...
                    stock: {
                        required: "Please provide a Stock Items",
                    },
                }
            });
        })
