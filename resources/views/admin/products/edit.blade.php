                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="hidden" id="categoryIds" name="categoryIds" value="{{ isset($product->subchild_category_id) ? ($product->primary_category_id.','.$product->child_category_id.','.$product->subchild_category_id) : ($product->primary_category_id.','.$product->child_category_id) }}">
                            <input type="hidden" id="childCategoryId" name="childCategoryId" value="{{ isset($product->child_category_id) ? $product->child_category_id: '' }}">
                                                        ...
                                                        <li class="nav-item dropdown CatDisabMenuLink disableCategory">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" style="position: absolute;">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    ?>
                                                                    <a class="dropdown-item dropdown-toggle parent-child" href="javascript:void(0)" data-val="<?php echo $cat['id']; ?>" data-title="<?php echo $cat['category_name']; ?>" parent-cat="<?php echo $cat['parent_category_id']; ?>" ><?php echo $cat['category_name']; ?></a>
                                                                    <?php
                                                                    echo viewsubcat($cat['subcategory']);
                                                                    } /*else {
                                                                */?><!--
                                                                <a class="dropdown-item last-child" href="javascript:void(0)" data-val="<?php /*echo $cat['id']; */?>" data-title="<?php /*echo $cat['category_name']; */?>" parent-cat="<?php /*echo $cat['parent_category_id']; */?>" ><?php /*echo $cat['category_name']; */?></a>
                                                                --><?php
                                                                    /*                                                                }*/
                                                                    ?>
                                                                </li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div id="AttrVariationBox" class="col-lg-8 col-md-8 col-sm-12 col-xs-12 ml-2">
                                                    <div class="basic-dropdown">
                                                        <div class="dropdown">
                                                            <button type="button" type="button" class="btn btn-grey dropdown-toggle" data-toggle="dropdown" id="AttrVariationBtn">{{ 'Select '.$product->attribute->attribute_name }}</button>
                                                            <div class="dropdown-menu">
                                                                <div class="form-group p-2 mb-0">
                                                                    <div class="col-sm-12">
                                                                        <div class="dropAttrTermDiv" id="AttrTermDiv">
                                                                            @foreach ($product->attribute->attributeterm as $term)
                                                                                <div class="form-check mb-2"><label class="form-check-label CatVariSel"><input type="checkbox" id="termCheckbox{{ $term['id'] }}" class="form-check-input TermSelCheckbox" name="TermSelCheckbox[]" data-boxid = "{{ $term['id'] }}" data-category="{{ isset($product->subchild_category_id)?$product->subchild_category_id:$product->child_category_id }}" @if(in_array($term['id'],$attr_term_ids)) checked @endif data-name="{{ $term['attrterm_name'] }}">{{ $term['attrterm_name'] }}</label></div>
                                                                            @endforeach
                                                                        </div>
                                                                    </div>
                                                                </div>
                            ...
                            <div class="row variation-box" id="variant-data">
                                ...
                                <div id ="" class="single-variation-box col-lg-6 col-md-6 col-sm-12 col-xs-12 panel panel-default" data-term="{{ $term->attrterm_name }}">
                                    <div class="variation-selection-box row panel-heading active">
                                        ...
                                        <div class="col-lg-2 col-sm-2 actionbox ml-auto"><a role="button" class="collapse-arrow variantbox-collapse" data-toggle="collapse" href="#" aria-expanded="true" onclick="collapsePanel(this)"></a><div id=""></div></div>
                                    </div>
                                    <div id="" role="tabpanel" class="panel-collapse collapse show variation-product-box">
                                        <form method="post" enctype="multipart/form-data" class="variantForm" id="variantForm">
                                                                        ...
                                                                        <li id="oldVarImgBox{{ $product_variant['term_item_id'] }}-{{ $vcnt }}" class="jFiler-item" data-jfiler-index="1" style="">
                                                                            <div class="jFiler-item-container">
                                                                                <div class="jFiler-item-inner">
                                                                                    <div class="jFiler-item-thumb">
                                                                                        <div class="jFiler-item-status"></div>
                                                                                        <div class="jFiler-item-thumb-image"><img src="{{ url('public/'.$v_img) }}" draggable="false"></div>
                                                                                    </div>
                                                                                    <div class="jFiler-item-assets jFiler-row">
                                                                                        <ul class="list-inline pull-right">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <input type="number" class="form-control input-default stock" id="" name="stock" value="{{ $product_variant['stock'] }}">
                                            ...
                                            <?php $required_spec_data = get_required_specifications(isset($product->child_category_id) ? $product->child_category_id : ''); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <select class="form-control specReq {{ $primaryclass }}" id="" name="specReq{{ $required_specification['id'] }}">
                                                                <option></option>
                                                                @foreach($required_specification['attributeterm'] as $term)
                                                                    <?php $variant_term = \App\Models\ProductVariantSpecification::where('product_variant_id',$product_variant['id'])->where('attribute_term_id',$term['id'])->where('type',1)->first(); ?>
                                            ...
                                            <?php $optional_spec_data = get_optional_specifications(isset($product->child_category_id) ? $product->child_category_id : ''); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <select class="form-control specOpt {{ $primaryclass }}" data-id="{{ $optional_specification['id'] }}" name="specOpt{{ $optional_specification['id'] }}">
                                                                <option></option>
                                                                @foreach($optional_specification['attributeterm'] as $term)
                                                                    <?php $variant_term = \App\Models\ProductVariantSpecification::where('product_variant_id',$product_variant['id'])->where('attribute_term_id',$term['id'])->where('type',0)->first(); ?>
                                                                    <option value="{{ $term['id'] }}" @if(isset($variant_term) && !empty($variant_term)) selected @endif >{{ $term['attrterm_name'] }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
