                    ...
                    <div class="modal-body">
                            <div id="attr-cover-spin" class="cover-spin"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{ url('public/images/placeholder_image.png') }}" class="" id="attrtermthumb_image_show" height="50px" width="50px" style="margin-top: 5px">
                                </div>
                    </div>
    ...
    $('body').on('click', '#editAttributeTermBtn', function () {
        ...
        $.get("{{ url('admin/attributeTerm') }}" +'/' + attributeterm_id +'/edit', function (data) {
            ...
            if(data.attrterm_thumb==null){
                ...
                var attrterm_thumb = "{{ url('public/images/attrTermThumb') }}" +"/" + data.attrterm_thumb;
