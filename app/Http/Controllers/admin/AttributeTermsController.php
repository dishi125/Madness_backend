...
class AttributeTermsController extends Controller
{
    ...
    public function index($id){
        ...
        return view('admin.attribute_terms.list',compact('attributeName'))->with('page',$this->page);
    }
...
//                $i=1;
                foreach ($attributeTerms as $attributeTerm)
                {
                    ...
                    if(isset($attributeTerm->attrterm_thumb) && $attributeTerm->attrterm_thumb!=null){
                        $thumb_path = url('public/images/attrTermThumb/'.$attributeTerm->attrterm_thumb);
                    }
                    else{
                        $thumb_path = url('public/images/placeholder_image.png');
                    }
