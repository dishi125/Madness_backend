jQuery(document).ready(function(){
    ...
    jQuery("#BannerFiles").filer({
        ...
        uploadFile: {
            url: ImageUrl+"homepagebanners/uploadfile?action=uploadBannerImg",
        ...
        onRemove: function(itemEl, file, id, listEl, boxEl, newInputEl, inputEl){
            ...
            jQuery.post(ImageUrl+'homepagebanners/removefile?action=removeBannerImg', {'_token': $('meta[name="csrf-token"]').attr('content'), file: removableFile});
