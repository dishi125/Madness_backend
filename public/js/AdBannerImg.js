...
jQuery("#AdBannerFiles-1").filer({
    ...
    uploadFile: {
        ...
        success: function(res, itemEl, listEl, boxEl, newInputEl, inputEl, id){
            ...
            jQuery("#AdBannerImg-1").val(new_file_name);
    ...
    onRemove: function(itemEl, file, id, listEl, boxEl, newInputEl, inputEl){
        ...
        var removableFile = jQuery("#AdBannerImg-1").val();
        ...
        jQuery("#AdBannerImg-1").removeAttr('value');
    },
    onEmpty: null,
    options: null,
    dialogs: {
