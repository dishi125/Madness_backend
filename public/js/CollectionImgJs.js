jQuery(document).ready(function(){
    ...
    var CollectionImg = $("#CollectionImg").val();
        ...
        FileforEdit = [
            {
                ...
                size: 9453,
                type: "image/jpg",
                file: FileforEditUrl + CollectionImg,
                url: FileforEditUrl + CollectionImg
            }
        ];
    }

    jQuery("#CollectionFiles").filer({
        limit: 1,
        maxSize: null,
        ...
        uploadFile: {
            url: ImageUrl+"collections/uploadfile?action=uploadCollectionImg",
            ...
            success: function(res, itemEl, listEl, boxEl, newInputEl, inputEl, id){
                ...
                jQuery("#CollectionImg").val(new_file_name);
        ...
        onRemove: function(itemEl, file, id, listEl, boxEl, newInputEl, inputEl){
            ...
            var removableFile = jQuery("#CollectionImg").val();
            jQuery.post(ImageUrl+'collections/removefile?action=removeCollectionImg', {'_token': $('meta[name="csrf-token"]').attr('content'), file: removableFile});
            jQuery("#CollectionImg").removeAttr('value');
        },
        onEmpty: null,
        options: null,
        dialogs: {
