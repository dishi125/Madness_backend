jQuery(document).ready(function(){
    ...
    var NotificationImg = $("#NotificationImg").val();
        ...
        FileforEdit = [
            {
                ...
                size: 9453,
                type: "image/jpg",
                file: FileforEditUrl + NotificationImg,
                url: FileforEditUrl + NotificationImg
            }
        ];
    }

    jQuery("#NotificationFiles").filer({
        limit: 1,
        maxSize: null,
        ...
        uploadFile: {
            url: ImageUrl+"notifications/uploadfile?action=uploadNotificationImg",
            ...
            success: function(res, itemEl, listEl, boxEl, newInputEl, inputEl, id){
                ...
                jQuery("#NotificationImg").val(new_file_name);
        ...
        onRemove: function(itemEl, file, id, listEl, boxEl, newInputEl, inputEl){
            ...
            var removableFile = jQuery("#NotificationImg").val();
            jQuery.post(ImageUrl+'notifications/removefile?action=removeNotificationImg', {'_token': $('meta[name="csrf-token"]').attr('content'), file: removableFile});
            jQuery("#NotificationImg").removeAttr('value');
        },
        onEmpty: null,
        options: null,
        dialogs: {
